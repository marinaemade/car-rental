...
export default function CarDetails() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white dark:bg-black flex flex-col justify-center items-center transition-colors duration-300">
        <Spinner color="green" className="h-12 w-12 mb-4" />
        <Typography className="text-gray-500 dark:text-gray-400 animate-pulse">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="group relative bg-gray-100 dark:bg-white/5 rounded-3xl overflow-hidden border border-gray-200 dark:border-white/10 aspect-video mb-6">
              ...
              <div className="absolute top-4 right-4 flex gap-3">
                <button className="p-3 bg-white/70 dark:bg-black/50 backdrop-blur-md rounded-2xl text-gray-700 dark:text-white border border-gray-200 dark:border-white/10 hover:bg-red-500 hover:text-white transition">
