...
export default function BookingCard({ car }) {
  ...
  return (
    <div className="lg:col-span-1">
      {/* Price Card */}
      <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-white/10 mb-4 sticky top-4 transition-colors duration-300">
      ...
      {/* Need Help Card */}
      <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-white/10 p-6 transition-colors duration-300">
        <h3 className="font-bold text-gray-900 dark:text-white mb-3">Need help?</h3>
        <p className="text-gray-500 dark:text-gray-400 text-sm mb-4">
          Our team is available 24/7 to assist with your booking.
        </p>
        <button className="w-full border-2 border-green dark:border-green bg-green py-2 rounded-lg font-bold hover:bg-green dark:hover:bg-green transition flex items-center justify-center gap-2">
