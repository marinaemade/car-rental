    ...
    ">
      ...
      <CardHeader className="relative m-0 rounded-none h-48">
        ...
        <div className="absolute  bottom-3 right-3 bg-darkGreen  backdrop-blur-md px-3 py-1 rounded-lg border border-green-400/30">
          <Typography className=" font-bold text-sm">
            ${car.price}
            <span className="text-gray-500  dark:text-gray text-xs font-normal">/day</span>
          </Typography>
        </div>
      ...
      <CardBody className="p-5 flex-1">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-md flex flex-col items-center border border-gray-200 dark:border-white/10">
