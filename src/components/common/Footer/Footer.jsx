      ...
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="w-full">
            <Link
              to="/"
              className="flex items-center gap-2 text-white font-bold text-2xl mb-4 group"
            >
              ...
              <span>
                Rahal
                <span className="text-green transition-colors group-hover:text-softGreen">
                  Car
                </span>
              </span>
            </Link>
            <Typography className="mb-6 font-normal text-gray text-sm leading-relaxed">
              Premium car rental for every journey. From sports cars to family
              SUVs, we have the perfect vehicle for your adventure.
            </Typography>
          ...
          <div className="w-full">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <Link
                  to="/contact"
                  className="text-white font-bold text-sm hover:text-green transition-colors cursor-pointer"
                >
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-lightDark py-6 md:flex-row md:justify-between">
          <Typography className="mb-4 text-center text-xs font-normal text-gray md:mb-0">
            &copy; {currentYear} <span className="text-green">RahalCar</span>.
            All rights reserved.
          </Typography>
